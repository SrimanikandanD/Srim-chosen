$(document).ready(function () {
    ...
    var len_x_1 = $('.srim-drop-down').length;

    for (var j = 0; j < len_x_1; j++) {      
        
        var id_of_input = $('.srim-drop-down').eq(j).attr('id');

        $('#' + id_of_input).addClass('hidden');

        $(".srim-drop-down").eq(j).after('<input type="text" class="form-control srim_dropdown_val" id="dynamic_product_values_' + id_of_input + '" readonly="">');
